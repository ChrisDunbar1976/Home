-- Rhubarb Press Accounting System - UK Compliance Tables (FIXED)
...
PRINT 'UK compliance schema created successfully for Rhubarb Press (FIXED VERSION)';