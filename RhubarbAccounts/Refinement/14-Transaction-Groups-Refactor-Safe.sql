-- Rhubarb Press Accounting System - Transaction Groups Refactor (SAFE VERSION)
...
PRINT 'Starting SAFE Transaction Groups refactoring';
...
-- =============================================
PRINT '=== STEP 4: Creating Helper Procedures ===';
