...
CREATE TABLE BankBalanceHistory (
    ...
    TransactionID INT NOT NULL, -- Transaction that caused this change
...
-- =============================================
-- Initialize Bank Balance for Main Bank Account
-- =============================================
...
BEGIN
    ...
    BEGIN TRY
        ...
        VALUES (
            ...
            0, @OpeningDate, 'Opening Balance', @OpeningBalance,
...
-- Called by triggers when transactions are added/modified
-- =============================================
...
-- =============================================
CREATE OR ALTER TRIGGER tr_TransactionLines_UpdateBankBalance
ON TransactionLines
AFTER INSERT
AS
BEGIN
...
CREATE OR ALTER VIEW CurrentBankBalances AS
SELECT
    coa.AccountCode,
    coa.AccountName,
    bb.CurrentBalance,
...
CREATE OR ALTER VIEW BankBalanceAuditTrail AS
...
PRINT '2. Import your transactions - balances will update automatically';
PRINT '3. Query: SELECT * FROM CurrentBankBalances;';
PRINT '4. Audit: SELECT * FROM BankBalanceAuditTrail;';
GO