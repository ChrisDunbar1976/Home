-- Rhubarb Press Accounting System - Publishing Business Procedures
...
PRINT 'Creating Publishing Business Procedures for Rhubarb Press';
...
-- =============================================
PRINT 'Creating sp_CreateJournalEntry...';
GO
...
-- =============================================
PRINT 'Creating sp_CreateInvoice...';
GO
...
-- =============================================
PRINT 'Creating sp_ProcessBookSales...';
GO

CREATE OR ALTER PROCEDURE sp_ProcessBookSales
    @BookID INT,
    @ChannelID INT,
    @SaleDate DATE,
    @QuantitySold INT,
...
-- =============================================
PRINT 'Creating sp_CalculateAuthorRoyalties...';
GO

CREATE OR ALTER PROCEDURE sp_CalculateAuthorRoyalties
    @PeriodStart DATE,
    @PeriodEnd DATE,
...
-- =============================================
PRINT 'Creating sp_BookProfitabilityReport...';
GO

CREATE OR ALTER PROCEDURE sp_BookProfitabilityReport
    @BookID INT = NULL,
...
-- =============================================
PRINT 'Creating sp_GenerateTrialBalance...';
GO
...
-- Dashboard Summary
-- =============================================
PRINT 'Creating sp_DashboardSummary...';
GO
...
-- =============================================
-- Setup Bank Import Accounts (helper procedure)
-- =============================================
PRINT 'Creating sp_SetupBankImportAccounts...';
GO
...
-- =============================================
-- Bulk Import Bank Transactions (placeholder for future CSV import)
-- =============================================
PRINT 'Creating sp_BulkImportBankTransactions...';
GO
...
PRINT '';
PRINT '=== Publishing Business Procedures Created Successfully ===';
PRINT 'Procedures created:';
PRINT '  - sp_CreateJournalEntry: Create manual journal entries';
PRINT '  - sp_CreateInvoice: Create customer invoices with JSON lines';
PRINT '  - sp_ProcessBookSales: Import and process book sales';
PRINT '  - sp_CalculateAuthorRoyalties: Calculate royalties for period';
PRINT '  - sp_BookProfitabilityReport: Book profitability analysis';
PRINT '  - sp_GenerateTrialBalance: Generate trial balance as of date';
PRINT '  - sp_DashboardSummary: Dashboard summary metrics';
PRINT '  - sp_SetupBankImportAccounts: Setup accounts for bank imports';
PRINT '  - sp_BulkImportBankTransactions: Placeholder for CSV bulk import';
PRINT '';
PRINT 'Publishing business procedures are ready for use';
GO
