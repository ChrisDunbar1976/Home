...
-- =============================================
PRINT 'Creating account balances view...';
GO
...
-- =============================================
-- Trial Balance View (updated to use vw_AccountBalances)
-- =============================================
PRINT 'Creating trial balance view...';
GO
...
-- =============================================
-- Bank Balance Audit Trail View
-- =============================================
PRINT 'Creating bank balance audit trail view...';
GO
...
PRINT 'Core reporting views:';
PRINT '  - vw_AccountBalances: Current balance for all accounts';
PRINT '  - vw_TrialBalance: Traditional trial balance report';
PRINT '  - vw_BankBalanceAuditTrail: Bank balance history audit';
PRINT '';
PRINT 'Bank transaction views:';
...
PRINT '  SELECT * FROM vw_TrialBalance WHERE DebitBalance + CreditBalance > 0;';
PRINT '';
